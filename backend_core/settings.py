...
# Grab the secret key from the cloud environment, or use a dummy key for local testing
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-local-dummy-key-only')
